...
"""
    ...
    video_name = 'musina_denim.mp4'
    BUCKET_NAME = 'bedrockdemo-storagebedrockdemobucketd9b1e9c2-kgrvywww1w5w'
    MEDIA_CONVERT_ROLE = 'arn:aws:iam::927208760804:role/MediaConvert-GenAIDemo-Role'
    shortened_video_name, status = stitching_clips(video_name, tracks)
